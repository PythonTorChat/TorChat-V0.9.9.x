...
#TaskbarMenu
MTB_SHOW_HIDE_TORCHAT = u"Show/Hide tor.chat"
MTB_QUIT = u"Quit"
...
#warning about log
D_LOG_WARNING_TITLE = u"tor.chat: Logging is active"
...
D_WARN_USED_PORT_TITLE = u"tor.chat: Port already in use"
D_WARN_USED_PORT_MESSAGE = u"Something, probably another tor.chat instance, is already listening at %s:%s. You must create another profile using different ports to be able to start tor.chat a second time."

#warnig about unread messages
D_WARN_UNREAD_TITLE = u"tor.chat: Unread messages"
D_WARN_UNREAD_MESSAGE = u"There are unread messages.\nThey will be lost forever!\n\nDo you really want to exit tor.chat now?"

#warning about offline buddy
D_WARN_BUDDY_OFFLINE_TITLE = u"tor.chat: Buddy is offline"
D_WARN_BUDDY_OFFLINE_MESSAGE = u"This operation is not possible with offline buddies"

#warning about multiple files
D_WARN_FILE_ONLY_ONE_TITLE = u"tor.chat: Multiple files"
...
D_WARN_FILE_SAVE_ERROR_TITLE = u"tor.chat: Error saving file"
D_WARN_FILE_SAVE_ERROR_MESSAGE = u"The file '%s' could not be created.\n\n%s"

#warning about file already exists
D_WARN_FILE_ALREADY_EXISTS_TITLE = u"tor.chat: File exists"
...
#settings dialaog
DSET_TITLE = u"tor.chat configuration"
...
DSET_NET_OWN_HOSTNAME = u"Own tor.chat-ID"
...
MSG_OFFLINE_TITLE = u"tor.chat: queued messages"
...
#about box
ABOUT_TITLE = u"About tor.chat"
ABOUT_TEXT = u"""tor.chat %(version)s (svn: r%(svn)s)
  %(copyright)s
...
tor.chat is free software: you can redistribute it and/or \
modify it under the terms of the GNU General Public \
License as published by the Free Software Foundation, \
either version 3 of the License, or (at your option) \
any later version.

tor.chat is distributed in the hope that it will be useful, \
...
Please Help support future development and maintenance of tor.chat  
 -- Bitcoin tip-jar:  -- %(tipjar)s -- 
 -- every little bit helps.

If you would like to use a vanity torchat address, please visit 
              http://www.vanitytorchat.com 
   A percentage of all vanity tor.chat ID fees are pledged to help 
   support the ongoing development and maintenance of tor.chat
