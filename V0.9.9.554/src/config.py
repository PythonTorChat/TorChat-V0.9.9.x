...
config_defaults = {
    ...
    ("gui", "time_stamp_formatx") : "(%H;%M;%S)",
    ("gui", "color_time_stamp") : "#707070",
    ("gui", "color_nick_myself") : "#0c970d",
    ("gui", "color_nick_buddy") : "#a00000",
    ...
    ("profile", "name") : "",
    ("profile", "decor") : "uuuuuuuuuuuuuuuu",
    ("profile", "text") : "",
}
...
TIP_JAR = u"12xDwBTDJteJvknZuEFvvLe8Xrv6GMBnjF"

COPYRIGHT = u"""Copyright (c) 2007-2011 Bernd Kreuß <prof7bit@googlemail.com>  
Modifications and updates ---
Copyright (c) 2014-2019 M. Weigand <doctortor@use.safemail.com> 
Tor.chat Bitcoin tip jar: -- 12xDwBTDJteJvknZuEFvvLe8Xrv6GMBnjF -- 
<your generosity will help keep the updates flowing>"""
...
def getDataDir():
    ...
    if not os.path.exists(data_dir):
		...
		# TODO Copy entire tor dir for windows (JM)
