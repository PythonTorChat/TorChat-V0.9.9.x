...
config_defaults = {
    ...
    ("gui", "color_text_myself") : "#001000",
    ("gui", "color_text_buddy") : "#100000",
...
MINORVERSION_009554 = 9554
MAJORVERSION_000009 = 9
MAJORVERSION_000010 = 10
...
def isPortable():
    ...
    cdir = SCRIPT_DIR
    try:
        f = open(os.path.join(cdir, "portable.txt"), "r")
        f.close()
        return True
    except:
        return False
...
def getDataDir():
    ...
    # TODO Copy entire tor dir for windows (MW)
...
def getDbgOpt(section, option, defaultValue):
