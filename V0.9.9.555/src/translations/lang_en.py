...
DEC_MSG_16_CHARACTERS = u"The address must be 16 or 56 characters long, not %i."
...
LOG_HEADER4 = u"- fill the file with the evidence / fake conversations / incriminating evidence. When satisfied,"
