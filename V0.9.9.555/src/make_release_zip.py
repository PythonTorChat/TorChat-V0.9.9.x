...
#
#   python 2.7.x
#   wxpython 3.0 (the unicode version)
#   upx.exe (must be in the PATH)
#   pythonwin extensions (needed by pyinstaller)
#   pyinstaller latest trunk (in c:\pyinst\)
#
#   also put a copy of THE LATEST tor.exe into src/Tor
#
# run make_release_zip.py from within the src directory and
...
PYINSTALLER_PATH = "c:\\pyinstaller-2.1\\utils"
